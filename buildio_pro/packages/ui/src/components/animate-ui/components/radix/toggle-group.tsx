...
import { toggleVariants } from '@workspace/ui/components/animate-ui/components/radix/toggle';
import {
...
} from '@workspace/ui/components/animate-ui/primitives/radix/toggle-group';
