...
ALTER TABLE "folders" ADD CONSTRAINT "folders_topic_id_topics_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."topics"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "documents_topic_idx" ON "documents" USING btree ("topic_id");--> statement-breakpoint
...
CREATE INDEX "embeddings_resource_idx" ON "embeddings" USING btree ("resource_id");--> statement-breakpoint
...
CREATE INDEX "folders_topic_idx" ON "folders" USING btree ("topic_id");--> statement-breakpoint
...
CREATE INDEX "chat_threads_workspace_idx" ON "chat_threads" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "chat_threads_user_workspace_updated_at_idx" ON "chat_threads" USING btree ("user_id","workspace_id","updated_at");--> statement-breakpoint
CREATE INDEX "chat_threads_user_updated_at_idx" ON "chat_threads" USING btree ("user_id","updated_at");--> statement-breakpoint
CREATE INDEX "topics_workspace_idx" ON "topics" USING btree ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX "topics_slug_idx" ON "topics" USING btree ("workspace_id","slug") WHERE "topics"."deleted_at" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "workspace_members_user_workspace_uq" ON "workspace_members" USING btree ("user_id","workspace_id");--> statement-breakpoint
